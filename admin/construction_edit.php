...
$construction = $_POST['info'];



  $query = "UPDATE editor SET construction='$construction' where ID = '$ID'";
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i>Construction</li>
                ...
                <div class="form">
                  <form class="form-validate form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="form-group ">
                      ...
                      <div class="col-lg-8" >
                        <textarea class="form-control " name="info" required><?= $row['construction']; ?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
