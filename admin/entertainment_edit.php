...
$entertainment = $_POST['info'];



  $query = "UPDATE editor SET entertainment ='$entertainment' where ID = '$ID'";
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i>Entertainment</li>
                ...
                <div class="form">
                  <form class="form-validate form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="form-group ">
                      ...
                      <div class="col-lg-8" >
                        <textarea class="form-control " name="info" required><?= $row['entertainment']; ?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
