              ...
              <div class="panel-body">
                <div class="col-lg-2 col-sm-2">
                  ...
                  <div class="follow-ava">
                    <img src="img/SSE.jpg" width="50" height="40" alt="image">
                  </div>
                  <h6>Administrator</h6>
                </div>
                  ...
                  <div id="profile" class="tab-pane active">
                    <section class="panel">
                      <div class="panel-body bio-graph-info">
                        ...
                        <div class="row">
                          <div class="bio-row">
                            <p><span>First Name </span>:<b style="color: black;"> <?php echo $row['firstname']?></b> </p>
                          </div>
                          <div class="bio-row">
                            <p><span>Last Name </span>:<b style="color: black;"> <?php echo $row['lastname']?></b></p>
                          </div>
                          <div class="bio-row">
                            <p><span>Mobile No.</span>: <?php echo $row['phone']?></p>
                          </div>
                          <div class="bio-row">
                            <p><span>Email </span>: <?php echo $row['username']?></p>
                          </div>
